...
public class BattleStarter : MonoBehaviour
{
    ...
    public IEnumerator StartBattleCo()
    {
        ...
        BattleManager.instance.rewardItems = battles[selectedBattle].rewardItems;
        BattleManager.instance.rewardXP = battles[selectedBattle].rewardXP;

        yield return new WaitForSeconds(1.5f);

        BattleManager.instance.BattleStart(battles[selectedBattle].enemies, cannotFlee);
