...
public class ItemButton : MonoBehaviour
{
    ...
    public void Press() //klikom na item u?itava se naziv i opis, preko funkcije SelectItem()
    {
        if (GameMenu.instance.theMenu.activeInHierarchy)
        {
            if (GameManager.instance.itemsHeld[buttonValue] != "")
            {
                GameMenu.instance.SelectItem(GameManager.instance.GetItemDetails(GameManager.instance.itemsHeld[buttonValue])); //selektiranom itemu se ispisuje info
            }
        }
